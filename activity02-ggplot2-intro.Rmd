...
**Response**:With jitter plots you can observe more information about the data's behavior. You see the distribution of the points instead of the condensed version. But box plots also show the data very effectively and those allow one to observe the data relative to one another (in terms of statistical significance)
...
**Response**:The md was much easier to look at on github since the Rmd is all for the R code. 
...
**Response**:I prefer to have the box plot over the jitter plot since I can see the inside of the boxplot and I can see the points that reside outside of the box. 
...
**Response**:This will add another layer to the data and can let the user observe more behaviors/trends of the dataset.
